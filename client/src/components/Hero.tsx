...
export default function Hero() {
  return (
    <div className="relative isolate overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0 bg-linear-115 from-[#FCFFC1]/80 from-28% via-[#ee87cb]/80 via-70% to-[#b060ff]/80 sm:bg-linear-145 z-10 mix-blend-multiply">
      </div>
      ...
      <div className="relative z-20 mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        ...
        <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <Link
              to="/foodsearch"
              className="rounded-lg bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Nutrition API
            </Link>
